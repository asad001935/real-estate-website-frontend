...
export default function EditProperty() {
    ...
    const fetchProperty = async () => {
      try {
        const response = await axios.get(
          `https://real-estate-website-backend-3.onrender.com/api/property/getProperty/${id}`,
          {
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
       `https://real-estate-website-backend-3.onrender.com/api/property/editProperty/${id}`,
